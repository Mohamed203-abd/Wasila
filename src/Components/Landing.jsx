...
function Landing({ children, showSearch = false  }) {
        ...
        <div className="landing p-relative">
            ...
            <div className={`head ${showSearch ? "head-search" : ""} p-relative d-flex-c`}>
                ...
                <div className="icons d-flex-c c-pointer p-absolute">
                    <img src={myprofile} alt="Face" onClick={() => handleNavigate("/profile")} title="الملف الشخصي"
                    className={`face p-relative d-flex-c b-radius ${showSearch ? "img-search" : ""}`} />
                    <div className="menu-container" ref={menuRef}>
                        <div className={`menu-trigger  ${open ? 'open' : 'closed'}`} onClick={() => { setOpen(!open) }}>
                    ...
                    {!showSearch && (
                        <button
                        className="search-btn c-pointer b-radius" onClick={() => navigate('/filters')}
                        title="صفحة البحث"> <FontAwesomeIcon icon={faSearch} /> 
                        </button>
                    )}
                </div>
            </div>
